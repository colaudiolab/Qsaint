...
def main(args: Dict[str, Any]):
    ...
    for phase in range(0, args["phases"]):
        print(f"Phase {phase}")
        train_subset = dataset_train.subset_at_phase(phase, learner.memory)
        test_subsets = []
        ...
        if phase == 0:
            learner.learn(train_loader, dataset_train.base_size, phase, "Re-align")
        else:
            learner.learn(train_loader, dataset_train.phase_size, phase)
